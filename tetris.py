# -*- coding: utf-8 -*-
"""
Created on Sun Dec  6 09:50:32 2020
...
pygame.display.set_caption("Mediocre Tetris")
sad_face = 0
...
def menu(): # function to show the menu on the right
    ...
    textsurface = myotherfont.render("Mediocre Tetris v1.0", False, (0,0,0))
    fenetre.blit(textsurface, (455, 540))
    textsurface = myotherfont.render("Made By", False, (0,0,0))
    fenetre.blit(textsurface, (485, 560))
    textsurface = myotherfont.render("AN AMATEUR", False, (0,0,0))
